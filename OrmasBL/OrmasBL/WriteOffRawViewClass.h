#ifndef WRITEOFFRAWVIEWCLASS_H
#define WRITEOFFRAWVIEWCLASS_H

#include "WriteOffRawClass.h"

namespace BusinessLayer
{
	class WriteOffRawView : public WriteOffRaw
	{
	...
	public:
		WriteOffRawView(DataLayer::writeOffRawsViewCollection);
		WriteOffRawView(){};
		~WriteOffRawView(){};
