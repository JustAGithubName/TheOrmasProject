		...
		else
		{
			...
			else
			{
				...
				$string_out = $string_out."<div id='report-header' >
					<div id='report-name' style='font-family:\" Montserrat\", Montserrat, monospace; font-size:200%'>
						<b>Накладная</b><b> №</b><b>".$_POST['order-id']."</b>
					</div>
					<div id='report-period' style='font-family:\" Montserrat\", Montserrat, monospace; font-size:150%'><b>
						на ".$order_row['order_date']
					."</b></div>
				</div>
				<div id = 'row' width='50%' style='font-family:\" Montserrat\", Montserrat, monospace; font-size:120%'>
				...
				<div id='content'>
					<table style='font-family:\" Montserrat\", Montserrat, monospace; font-size:170%' class='reset-style simple'  border = 0px  cellpadding=5 style='border-spacing:0px;'>
				...
				<div id = 'row' width='50%' style='font-family:\" Montserrat\", Montserrat, monospace; font-size:200%'>
					На сумму: <b>".$total_sum."  ".$order_row['currency_name']."</b> 
				</div>
				</br>
				<div id = 'row' width='50%' style='font-family:\" Montserrat\", Montserrat, monospace; font-size:130%'>
	...
	if(isset($_POST['order-raw-id']))
	{
		...
		else
		{
			...
			else
			{
				...
				<div id='content'>
					<table style='font-family:\" Montserrat\", Montserrat, monospace; font-size:140%' class='reset-style simple'  border = 0px  cellpadding=5 style='border-spacing:0px;'>
						<th class='simple-data-print'><b>Наименование</b></th>
						<th class='simple-data-print'><b>Цена</b></th>
						<th class='simple-data-print' ><b>Кол.</b></th>
						";
