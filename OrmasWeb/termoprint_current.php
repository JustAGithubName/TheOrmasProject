	...
	{	
		...
		else
		{
			...
			else
			{
				...
				<div id = 'row' width='50%' style='font-family:\" Garamond\", Garamond, monospace; font-size:120%'>
				...
				<div id = 'row' width='50%' style='font-family:\" Garamond\", Garamond, monospace; font-size:130%'>
	...
	if(isset($_POST['order-raw-id']))
	{
		...
		else
		{
			...
			else
			{
				...
				<div id='content'>
					<table style='font-family:\" Garamond\", Garamond, monospace; font-size:140%' class='reset-style simple'  border = 0px  cellpadding=5 style='border-spacing:0px;'>
						<th class='simple-data-print'><b>Наименование</b></th>
						<th class='simple-data-print'><b>Цена</b></th>
						<th class='simple-data-print' ><b>Кол.</b></th>
						";
